...
class WalkForwardValidator:
    ...
    def prepare_walk_data(self, df: pd.DataFrame, walk_num: int) -> Tuple:
        ...
        test_dates = test_data.index[self.sequence_length:].to_numpy()
        ...
        return X_train_scaled, y_train, X_val_scaled, y_val, X_test_scaled, y_test, scaler, test_dates
    ...
    def train_walk(self, walk_num: int, data_tuple: Tuple) -> Dict:
        ...
        """
        X_train, y_train, X_val, y_val, X_test, y_test, scaler, test_dates = data_tuple
    ...
    def save_aggregated_outputs(self, output_dir: str):
        ...
        np.save(os.path.join(output_dir, 'test_dates.npy'), np.array(self.all_dates))
